...
| :---------------: | :--------: | :----------------: | :---------: | :----------: | :------: | :------------: |
|     VGAE [50]     |   单个图   |   一次生成整个图   |    节点     |      -       |   Yes    |      Yes       |
| **GraphVAE** [⑤1] | **数据集** | **一次生成整个图** | **节点/边** |      -       |  **No**  |    **Yes**     |
|  **MPGVAE** [52]  | **数据集** | **一次生成整个图** | **节点/边** |      -       | **Yes**  |     **No**     |
|    RGVAE [53]     |   数据集   |   一次生成整个图   |   节点/边   |      -       |   Yes    |       No       |
|   Graphite [54]   |   单个图   |   一次生成整个图   |    节点     |      -       |   Yes    |      Yes       |
|   NED-VAE [55]    |   数据集   |   一次生成整个图   |   节点/边   |      -       |   Yes    |      Yes       |
|    DGVAE [56]     |   数据集   |   一次生成整个图   |    节点     |      -       |   Yes    |      Yes       |
|    JTVAE [57]     |   数据集   |    生成子图结构    |   节点/边   |      -       |   Yes    |      Yes       |
| **HierVAE** [37]  | **数据集** |  **生成子图结构**  | **节点/边** |      -       | **Yes**  |    **Yes**     |
|   MHG-VAE [58]    |   数据集   |    生成子图结构    |   节点/边   |      -       |   Yes    |      Yes       |
| MoleculeChef [38] |   数据集   |    生成子图结构    |   节点/边   |      -       |   Yes    |      Yes       |
|    CGVAE [39]     |   数据集   |     逐节点生成     |   节点/边   |      -       |   Yes    |      Yes       |
|   DEFactor [40]   |   数据集   |     逐节点生成     |   节点/边   |      -       |   Yes    |       No       |
|    NeVAE [59]     |   数据集   |     逐节点生成     |   节点/边   |      -       |   Yes    |      Yes       |
|  GraphVRNN [41]   |   数据集   |     逐节点生成     |    节点     |      -       |   Yes    |       No       |
...
|  **CONDGEN** [61]   | **数据集** | **一次生成整个图** |    -     |              | **Yes**  |    **Yes**     |
